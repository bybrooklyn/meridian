...
**Totals:** 79 units, 66 in deleted scope, 13 retained, 0 unaccounted.
...
| check | id |
|---|---|
| `governance` | `census-assignment` |
| `governance` | `census-error` |
| `governance` | `census-schema` |
| `governance` | `census-schema-on-disk` |
| `governance` | `evidence-index` |
| `governance` | `format-enumeration` |
| `governance` | `missing-authority` |
| `governance` | `missing-census` |
| `governance` | `phase-cycle` |
| `governance` | `stale-census` |
