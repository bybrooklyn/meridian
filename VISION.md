...
suite](specs/MERIDIAN_MASTER_SPEC.md)'s authority order and validation.
...
[COMPETITIVE_PERFORMANCE_AND_QUALITY_SPEC.md](specs/COMPETITIVE_PERFORMANCE_AND_QUALITY_SPEC.md)
...
[GAMEPLAY_NARRATIVE_AND_SCRIPTING_SPEC.md](specs/GAMEPLAY_NARRATIVE_AND_SCRIPTING_SPEC.md)
...
by [PROCEDURAL_AUTHORING_SPEC.md](specs/PROCEDURAL_AUTHORING_SPEC.md),
...
[CAIRN_PHYSICS_SPEC.md](specs/CAIRN_PHYSICS_SPEC.md) (physics, early-stage)
and
[TORSANT_FIRE_FLUIDS_AND_THERMAL_SIMULATION_SPEC.md](specs/TORSANT_FIRE_FLUIDS_AND_THERMAL_SIMULATION_SPEC.md)
...
[AGENT_API_MCP_OLLAMA_AND_AI_SPEC.md](specs/AGENT_API_MCP_OLLAMA_AND_AI_SPEC.md),
...
engine. Owned by
[MULTIPLAYER_AND_SERVER_SPEC.md](specs/MULTIPLAYER_AND_SERVER_SPEC.md),
...
[MARQUEE_PROMOTIONAL_MEDIA_AND_EXPORT_SPEC.md](specs/MARQUEE_PROMOTIONAL_MEDIA_AND_EXPORT_SPEC.md)
...
[MODDING_AND_COMMUNITY_LIBRARY_SPEC.md](specs/MODDING_AND_COMMUNITY_LIBRARY_SPEC.md),
