...
cargo run -p meridian-build --bin meridian-build -- --cargo-test-no-run --workspace . --source-checkpoint local-cargo-test-no-run --toolchain local --target host -- -p meridian-core
~~~
