...
|---|---|---|---|
| Governance and release | GOV, REL, SEC | truthful specifications, evidence, trust, compatibility, and release policy | v0.5 closure passed locally; hosted run `30736118075` passed governance plus the Linux, Windows, and macOS implementation rows after bounded Linux CI/process-group recovery |
